...
trainset = datasets.CIFAR10Instance(root='/data/hanchuchu/datasets/', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True, num_workers=2)

testset = datasets.CIFAR10Instance(root='/data/hanchuchu/datasets/', train=False, download=True, transform=transform_test)
